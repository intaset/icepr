...
Thank you for registering for ICEPR 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@icepr.org. You can find the copyright form here: https://icepr.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
We are pleased to announce that the ICEPR 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://icepr.org/RealPalacioLisbonBookingForm.pdf
...
<footer id="contact">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LcbTP8SAAAAAIogJuqBBqi6kw46zgqqLxhOmdr7"></div></center>
  <div class="cf">
